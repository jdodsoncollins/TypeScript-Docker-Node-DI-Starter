...
var CreateOauthAccessToken_1 = require("../database/src/Action/Oauth/CreateOauthAccessToken");
var bcrypt = require("bcrypt");
exports.execute = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var code, redirectUri, responseType, clientId, userId, appCore, createOAuthAccessToken;
    return __generator(this, function (_a) {
        ...
        createOAuthAccessToken = new CreateOauthAccessToken_1.CreateOauthAccessToken(code, null, clientId, userId);
        return [2 /*return*/, res.json({ msg: 'success' })];
    });
}); };
