...
typeorm_1.createConnection(ormconfig_1.MysqlConnection.connect())
    .then(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    var appCore, newUserCommand, newUserResponse, getUserCommand, getUserResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                getUserCommand = new GetUser_1.GetUser(null, 'mickey@mickeymouse.com');
